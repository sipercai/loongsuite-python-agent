...
| [opentelemetry-instrumentation-microsoft-agent-framework](./opentelemetry-instrumentation-microsoft-agent-framework) | agent-framework-core >= 1.0.0 | Yes | development
